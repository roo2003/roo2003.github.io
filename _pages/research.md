 ...
 **Retrieval algorithm for monthly oceanic rainfall**
 ...
 ![]({{ site.url }}{{ site.baseurl }}/images/respic/passive3.jpg){: style="width: 45%; float: left; margin: 3%"}
 ![]({{ site.url }}{{ site.baseurl }}/images/respic/passive4.jpg){: style="width: 45%; float: right; margin: 3%"}  
