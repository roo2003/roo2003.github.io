 ...
 **Development of a rainfall retrieval algorithm based a parametric approach**
 ...
 ![]({{ site.url }}{{ site.baseurl }}/images/respic/passive1.jpg){: style="width: "75%"; float: none; margin: 0px  0px"}
 
 ![]({{ site.url }}{{ site.baseurl }}/images/respic/passive2.jpg){: style="width: "75%"; float: none; margin: 0px  0px"}
